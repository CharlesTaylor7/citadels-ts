...
import { Rank, RoleName, RoleData } from './roles';
...
export const ROLES: RoleData[] = [
  ...
  // Rank 4 characters
  {
    ...
    actions: [[1, 'TakeCrown' as ActionTag], [1, 'GoldFromNobility' as ActionTag]],
  ...
  },
  {
    ...
    set: 'DarkCity',
    suit: CARD_SUIT.NOBLE,
    actions: [[1, 'EmperorGiveCrown' as ActionTag], [1, 'GoldFromNobility' as ActionTag]],
    description: "Give the crown to another player and take 1 of their gold or 1 of their cards. Gain 1 gold for each of your NOBLE districts.",
  ...
  },
  {
    ...
    set: 'Citadels2016',
    suit: CARD_SUIT.NOBLE,
    actions: [[1, 'PatricianTakeCrown' as ActionTag], [1, 'GoldFromNobility' as ActionTag]],
    description: "Take the crown. At the end of the game, score 1 extra point for each NOBLE district in your city. Gain 1 gold for each of your NOBLE districts.",
    reminder: ""
  },
  ...
  },
  {
    ...
    set: 'DarkCity',
    suit: CARD_SUIT.RELIGIOUS,
    actions: [[1, 'TakeFromRich' as ActionTag], [1, 'ResourcesFromReligion' as ActionTag]],
    description: "Take 1 gold or 1 card from the player with the most gold. Gain 1 gold or 1 card for each of your RELIGIOUS districts.",
    reminder: ""
  },
  {
    rank: 'Five',
    ...
    set: 'Citadels2016',
    suit: CARD_SUIT.RELIGIOUS,
    actions: [[1, 'CardinalExchange' as ActionTag], [1, 'GoldFromReligion' as ActionTag]],
    description: "When another player builds a district, you can exchange cards from your hand for their gold. Gain 1 gold for each of your RELIGIOUS districts.",
    reminder: ""
  },
  ...
  // Rank 6 characters
  {
    ...
    actions: [[1, 'MerchantGainOneGold' as ActionTag], [1, 'GoldFromTrade' as ActionTag]],
  ...
  // Rank 8 characters
  {
    ...
    actions: [[1, 'GoldFromMilitary' as ActionTag], [1, 'WarlordDestroy' as ActionTag]],
  ...
  },
  {
    ...
    set: 'DarkCity',
    suit: CARD_SUIT.MILITARY,
    actions: [[1, 'GoldFromMilitary' as ActionTag], [1, 'DiplomatTrade' as ActionTag]],
  ...
  },
  {
    ...
    set: 'Citadels2016',
    suit: CARD_SUIT.MILITARY,
    actions: [[1, 'GoldFromMilitary' as ActionTag], [1, 'MarshalSeize' as ActionTag]],
